            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0" style="height: 600px;">
                        ...
                        <div class="row">
                        <div class="col-lg-6 d-none d-lg-block" style="height: 600px; width: 650px; background-image: url('<?php echo base_url('assets/admin_assets/img/login.jpg'); ?>'); background-size: cover;"></div>

                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4" style="height: 80px; margin-top:30px">Welcome Back!</h1>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url('register');?>">Register</a>
                                    </div>
                                </div>
                            </div>
                        </div>
