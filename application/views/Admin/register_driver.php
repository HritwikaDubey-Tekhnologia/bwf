                            ...
                            <div class="card-body p-0">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Driver Registration Form</h1>
                                    </div>
                                    <div class="card-body">
                                        <!-- Registration form -->
                                        <form action="<?php echo base_url('admin/registerDriver'); ?>" method="post">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="userID">User ID:</label>
                                                            <input type="text" class="form-control form-control-user" name="userID" value="<?php echo set_value('userID'); ?>" required>
                                                        </div>
                                            ...
                                            <br><br><input type="submit" value="Register Driver">
                                        </form>
                                    </div>
                                </div>
                            </div>
